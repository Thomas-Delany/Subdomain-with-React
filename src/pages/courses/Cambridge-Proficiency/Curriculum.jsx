...
const Curriculum = ({ unit }) => {
  return (
    <section className="bg-[#013266] py-8 md:py-16">
      <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
        <h2 className="text-4xl md:text-6xl text-center font-bold font-dosis text-[#ffd500] py-4">
          Study Plan
        </h2>
          ...
          <div key={index} className="grid place-items-center py-8 px-2">
            ...
            <div className="flex items-center justify-center w-10/12 rounded-3xl p-8 bg-[#ffd500]">
              ...
              <div className="hidden md:flex justify-center items-center bg-white rounded-full p-4 mr-6">
                <unitItem.icon className="text-[#013266] text-6xl md:text-5xl lg:text-6xl" />
              </div>

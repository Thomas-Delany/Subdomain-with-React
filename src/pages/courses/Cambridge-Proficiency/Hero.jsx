    ...
    <section className="bg-[#013266]">
      <div className="max-w-screen-xl px-8 md:px-28 py-8 mx-auto lg:gap-8 xl:gap-0 grid lg:grid-cols-12 lg:py-10 flex justify-between items-center">
        <div className="mr-auto lg:col-span-7 mx-auto p-6">
          ...
          <p className="max-w-2xl mb-4 font-black lg:mb-4 text-2xl md:text-3xl text-[#ffd500] text-left font-dosis">
            What you will learn
          </p>
          ...
          <div className="text-center md:text-left pt-8">
            <Link to={`${baseUrl}`}>
              <button
                type="button"
                className="w-32 h-12 text-white bg-[#ffd500] font-bold font-dosis rounded-lg text-lg px-5 py-2.5 me-2 mb-2"
              >
                Begin!
              </button>
            </Link>
        ...
        <div className="hidden lg:col-span-5 lg:flex justify-center items-center mx-auto h-[400px]">
          <h2 className="font-bryndan font-black text-[#ffd500] text-[350px]">
            XX
          </h2>
        </div>
      </div>

    ...
    <section className="bg-[#155b54]">
      <div className="max-w-screen-xl px-8 md:px-28 py-8 mx-auto lg:gap-8 xl:gap-0 grid lg:grid-cols-12 lg:py-10 flex justify-between items-center">
        <div className="mr-auto lg:col-span-7 mx-auto p-6">
          <h1 className="max-w-2xl mb-5 tracking-normal text-4xl md:text-5xl text-[#fdf1bb] font-bryndan font-bold pb-4 text-center md:text-left">
            C1 — Advanced
          </h1>
          <p className="max-w-2xl mb-4 font-black lg:mb-4 text-2xl md:text-3xl text-[#fdf1bb] text-left font-dosis">
            What you will learn
          </p>
          ...
          <div className="text-center md:text-left pt-8">
            <Link to={`${baseUrl}`}>
              <button
                type="button"
                className="w-32 h-12 text-[#155b54] bg-[#fdf1bb] font-bold font-dosis rounded-lg text-lg px-5 py-2.5 me-2 mb-2"
              >
                Begin!
              </button>
            </Link>
        ...
        <div className="hidden lg:col-span-5 lg:flex justify-center items-center mx-auto h-[400px]">
          <h2 className="font-bryndan font-black text-[#fdf1bb] text-[350px]">
            C1
          </h2>
        </div>
      </div>
